...
export class CartService {
      ...
      if (this.cartDataServer.data[0].product === undefined) {
        ...
        if (index !== -1) {
          if (quantity !== undefined && quantity <= prod.stockquantity) {
            this.cartDataServer.data[index].numInCart = this.cartDataServer.data[index].numInCart < prod.stockquantity ? quantity : prod.stockquantity;
          } else {
            // tslint:disable-next-line:no-unused-expression
            this.cartDataServer.data[index].numInCart < prod.stockquantity ? this.cartDataServer.data[index].numInCart++ : prod.stockquantity;
          }
  ...
  UpdateCartItems(index: number, increase: boolean) {
    ...
    if (increase) {
      data.numInCart < data.product.stockquantity ? data.numInCart++ : data.product.stockquantity;
